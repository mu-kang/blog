...
if (typeof jQuery === 'undefined') throw new Error("Bootstrap's JavaScript requires jQuery"); +function(a) { 'use strict'; const b = a.fn.jquery.split(' ')[0].split('.'); if (b[0] < 2 && b[1] < 9 || b[0] == 1 && b[1] == 9 && b[2] < 1) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher"); }(jQuery), +function(a) {
  ...
  'use strict'; function b(b) {
    ...
    d = function(b) { a(b).on('click', c, this.close); }; d.VERSION = '3.3.4', d.TRANSITION_DURATION = 150, d.prototype.close = function(b) {
  ...
  'use strict'; function b(b) {
    ...
    g = function(b) { a(b).on('click.bs.dropdown', this.toggle); }; g.VERSION = '3.3.4', g.prototype.toggle = function(d) {
    ...
    if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target.tagName)) {
      const d = a(this); if (b.preventDefault(), b.stopPropagation(), !d.is('.disabled, :disabled')) {
        const e = c(d),
          g = e.hasClass('open'); if (!g && b.which != 27 || g && b.which == 27) return b.which == 27 && e.find(f).trigger('focus'), d.trigger('click'); const h = ' li:not(.disabled):visible a',
  ...
  'use strict'; function b(b, d) {
    ...
    b && b.preventDefault(), b = a.Event('hide.bs.modal'), this.$element.trigger(b), this.isShown && !b.isDefaultPrevented() && (this.isShown = !1, this.escape(), this.resize(), a(document).off('focusin.bs.modal'), this.$element.removeClass('in').attr('aria-hidden', !0).off('click.dismiss.bs.modal')
    ...
    const d = this,
      e = this.$element.hasClass('fade') ? 'fade' : ''; if (this.isShown && this.options.backdrop) { const f = a.support.transition && e; if (this.$backdrop = a('<div class="modal-backdrop ' + e + '" />').appendTo(this.$body), this.$element.on('click.dismiss.bs.modal', a.proxy(function(a) { return this.ignoreBackdropClick ? void (this.ignoreBackdropClick = !1) : void (a.target === a.currentTarget && (this.options.backdrop == 'static' ? this.$element[0].focus() : this.hide())); }, this)), f && this.$backdrop[0].offsetWidth, this.$backdrop.addClass('in'), !b) return; f ? this.$backdrop.one('bsTransitionEnd', b).emulateTransitionEnd(c.BACKDROP_TRANSITION_DURATION) : b(); } else if (!this.isShown && this.$backdrop) { this.$backdrop.removeClass('in'); const g = function() { d.removeBackdrop(), b && b(); }; a.support.transition && this.$element.hasClass('fade') ? this.$backdrop.one('bsTransitionEnd', g).emulateTransitionEnd(c.BACKDROP_TRANSITION_DURATION) : g(); } else b && b();
  ...
  'use strict'; function b(b) {
    ...
    if (this.$element.is(':visible')) {
      let b = this.$element.height(),
        ...
        e = d.top,
        f = d.bottom,
        g = a(document.body).height(); typeof d !== 'object' && (f = e = d), typeof e === 'function' && (e = d.top(this.$element)), typeof f === 'function' && (f = d.bottom(this.$element)); const h = this.getState(g, b, e, f); if (this.affixed != h) {
